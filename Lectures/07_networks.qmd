...
format:
  revealjs: 
    ...
    chalkboard: 
      buttons: false
    logo: images/XAI.png
    footer: xML -- Explanations specific to neural networks -- MIM UW -- 2023
---
...
- Since 2017 till now (2023), the paper has 4935 citations showing a breakthrough in explaining neural networks.
